...
Tn.yt_embedsEnableIframeSrcWithIntent?Ad(c,Od(h)):c.setAttribute("data-src", h);//c.src=h;
return c}
...
(a=a.replace(Fb,"&#0;")));return'<iframe width="'+b+'" height="'+c+'" data-src="'+a+'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'};
