...
var language = navigator.language.toLowerCase()||navigator.userLanguage.toLowerCase() || 'en';
...
//判断用户的语言，跳转到不同的地方，如果相同则不跳转
if (($host.indexOf('www') > -1) || ($host.indexOf(language + '.') > -1) ){
   console.log(language);
} else if (language.indexOf('en') > -1){
    window.location = 'https://www.solarpanelproductionline.com' + $pathname + $search
} else if (languges.indexOf(language) > - 1){
    //符合语言
    window.location = 'https://' + language + '.solarpanelproductionline.com' + $pathname + $search
    //console.log('https://' + language + '.solarpanelproductionline.com' + $pathname + $search)
}
else{
    //其他
    window.location = 'https://www.solarpanelproductionline.com' + $pathname + $search
